...
const ProjectCard = ({ data, projectsdata }) => {
  ...
  return (
    <a
      href={data?.link}
      target="_blank"
      className={`relative sm:h-[25rem] h-[20rem] shadow-lg rounded-lg cursor-pointer flex text-white font-Poppins  flex-col gap-5 hover:scale-[1.02] transition-all duration-300`}
